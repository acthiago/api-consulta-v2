...
from ..dtos.pagamento_dto import ProcessarPagamentoRequestDTO, ProcessarPagamentoResponseDTO
...
class ProcessarPagamentoUseCase:
    ...
    async def execute(self, request: ProcessarPagamentoRequestDTO) -> ProcessarPagamentoResponseDTO:
        """
